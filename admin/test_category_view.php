 ...
 <?php  include('top_nav.php'); ?>
  ...
  ?>
    <tr>
      ...
      <td><a href="test_category_edit.php?test_category_id=<?php echo $row['test_category_id'];?>" class="btn btn-info">Edit</a></td>
	  <td><a href="test_category_delete.php?test_category_id=<?php echo $row['test_category_id'];?>" class="btn btn-danger">Delete</a></td>
    </tr>
	 <?php
  }
  ?>
