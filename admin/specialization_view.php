 ...
 <?php  include('top_nav.php'); ?>
  ...
  ?>
    <tr>
      ...
      <td><a href="specialization_edit.php?specialization_id=<?php echo $row['specialization_id'];?>" class="btn btn-info">Edit</a></td>
	  <td><a href="specialization_delete.php?specialization_id=<?php echo $row['specialization_id'];?>" class="btn btn-danger">Delete</a></td>
    </tr>
	 <?php
  }
  ?>
