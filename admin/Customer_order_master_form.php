...
<form name="formID" ID="formID" method="post" enctype="multipart/form-data" action="customer_order_master_insert.php">
 <table class="table table-striped table-bordered table-hover"    >
    ...
    <tr>
	 ...
	 <td><input name="attachment_details" type="file" id="attachment_details" size="10"  class="validate[required] form-control"></td> 
 ...
 <table class="table table-bordered table-hover tablesorter"  id="demo-dtable-01"  >
    ...
    <tr>
      ...
      <td>&nbsp;<?php echo $qnt; ?></td>
	  <td>&nbsp;<a href="../images/<?php echo $row3['attachment_details']; ?>" target="_blank" class="btn btn-info">View Reports</a></td>
