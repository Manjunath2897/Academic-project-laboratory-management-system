...
<!--       <th>edit</th>
  ...
  $sql="select * from appointment a,patient p,test_service ts where a.patient_id=p.patient_id and a.test_service_id=ts.test_service_id and a.appointment_status='Pending' ";
