...
<body>
 ...
 <?php  include('top_nav.php'); ?>
  ...
  $sql="select * from appointment a,patient p,test_service ts,technician tc where a.patient_id=p.patient_id and a.test_service_id=ts.test_service_id and a.technician_id=tc.technician_id";
  ...
  ?>
    <tr>
	  ...
	  <td><a href="appointment_edit.php?appointment_id=<?php echo $row['appointment_id'];?>">Edit</a></td>
	    <td><a href="appointment_delete.php?appointment_id=<?php echo $row['appointment_id'];?>">Delete</a></td>
    </tr>
	 <?php
  }
  ?>
