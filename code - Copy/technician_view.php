...
<body>
 ...
 <?php  include('top_nav.php'); ?>
  ...
  ?>
    <tr>
      <td><?php echo $sl++; ?></td>
      <td><?php echo $row['test_service_id']; ?></td>
      <td><?php echo $row['technician_name']; ?></td>
      <td><?php echo $row['specialization_id']; ?></td>
      <td><?php echo $row['email_id']; ?></td>
      <td><?php echo $row['contact_no']; ?></td>
      <td><?php echo $row['address']; ?></td>
      <td><a href="technician_edit.php?technician_id=<?php echo $row['technician_id'];?>">Edit</a></td>
	  <td><a href="technician_delete.php?technician_id=<?php echo $row['technician_id'];?>">Delete</a></td>
    </tr>
	 <?php
  }
  ?>
