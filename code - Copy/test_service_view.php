 ...
 <?php  include('top_nav.php'); ?>
  ...
  ?>
    <tr>
      ...
      <td><a href="test_service_edit.php?test_service_id=<?php echo $row['test_service_id'];?>">Edit</a></td>
	  <td><a href="test_service_delete.php?test_service_id=<?php echo $row['test_service_id'];?>">Delete</a></td>
    </tr>
	 <?php
  }
  ?>
