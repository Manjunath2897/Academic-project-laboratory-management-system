...
<body>
 ...
 <?php  include('top_nav.php'); ?>
	...
	<!-- Breadcomb area End-->
<form name="form1" form id="formID" method="post" action="technician_insert.php">
  <p>&nbsp;</p>
  <table width="580" height="539" border="0" align="center">
    <tr>
  ...
  ?>
    ...
    <tr>
      ...
      <td><input name="technician_name" type="text" id="technician_name" class="form-control validate[required]"></td>
    </tr>
    <tr>
